				...
				<div className={styles.footerContainer}>
					<div className={styles.footerInfo}>
						...
						<div className={styles.footer2}>
							...
							<button style={{ border: "none", marginRight: "-.5rem" }} type='button' data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action='https://getform.io/f/9e90f343-83d2-4804-8fb9-1bf8089ba2e5' method="POST" encType="multipart/form-data">
												<div class="mb-3">
