...
const Home = () => {
	...
	return (
		<div className={styles.container}>
			...
			>
				<Carousel.Item>
					<img className={styles.img} src={carrusel1} alt="First slide" />

					<Carousel.Caption></Carousel.Caption>
				</Carousel.Item>

				<Carousel.Item>
					<img className={styles.img} src={sucursal3} alt="Second slide" />

					<Carousel.Caption></Carousel.Caption>
				</Carousel.Item>

				<Carousel.Item>
					<img className={styles.img} src={carrusel2} alt="Third slide" />
				...
				<div className={styles.promociones}>
					<div>
						<Link to="/products/1d7df98a-a672-474a-92ee-58ae7d0f31ec">
							<img className={styles.img2} src={fatty} alt="Third slide" />
						</Link>
