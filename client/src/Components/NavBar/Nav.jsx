				...
				<div style={{ color: 'red', display: 'flex', marginRight: '10px', alignItems: 'center', justifyContent: 'center', gap: '2rem' }}>
					{cart.length > 0 ? (
						<div>
							...
							<div>
								<img src={emptycart} style={{ marginRight: '4.5rem' }} alt='xd' />
							</div>
						</div>
					) :
						<Link className='nav-link' to='/carrito'>
							<svg xmlns="http://www.w3.org/2000/svg" width="40" height="4" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
